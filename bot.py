...
# ─── الكوكيز: الأولوية للملف السري ثم المتغيرات البيئية ────
COOKIE_FILE = None

# 1. هل يوجد Secret File في /etc/secrets/cookies.txt؟
SECRET_FILE = "/etc/secrets/cookies.txt"
if os.path.exists(SECRET_FILE):
    COOKIE_FILE = SECRET_FILE
    logging.info("🍪 Using cookies from Render Secret File")
else:
    # 2. هل يوجد COOKIES_TEXT؟
    ...
    if COOKIES_TEXT:
        ...
        logging.info("🍪 Using cookies from COOKIES_TEXT")
    else:
        # 3. هل يوجد COOKIES_JSON؟
            ...
            try:
                ...
                if lines:
                    ...
                    with open(COOKIE_FILE, "w", encoding="utf-8") as f:
                        f.write("# Netscape HTTP Cookie File\n# generated by YAMD\n")
                        f.write("\n".join(lines))
                    logging.info("🍪 Using cookies from COOKIES_JSON")
            except Exception as e:
                logging.error(f"Cookies JSON error: {e}")
