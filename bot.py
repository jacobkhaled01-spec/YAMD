...
# ─── Cookies (JSON أو Netscape مباشر) ────
COOKIES_JSON = os.environ.get("COOKIES_JSON", "")
COOKIES_TEXT = os.environ.get("COOKIES_TEXT", "")  # ✨ جديد: نص Netscape جاهز
COOKIE_FILE  = None
...
if COOKIES_TEXT:
    ...
    logging.info("🍪 Cookies loaded from COOKIES_TEXT")
elif COOKIES_JSON:
    try:
        ...
        if lines:
            ...
            with open(COOKIE_FILE, "w", encoding="utf-8") as f:
                f.write("# Netscape HTTP Cookie File\n# generated by YAMD\n")
                f.write("\n".join(lines))
            logging.info("🍪 Cookies loaded from COOKIES_JSON")
    except Exception as e:
        logging.error(f"Cookies error: {e}")
